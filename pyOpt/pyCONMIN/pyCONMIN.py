        ...
        **Keyword arguments:**
        ...
        if self.poa and sens_mode.lower() == 'pgc':
            raise NotImplementedError(
                "pyCONMIN- Current implementation only allows single level parallelization, either 'POA' or 'pgc'")
        ...
        def cnmngrd(n1, n2, x, f, g, ct, df, a, ic, nac):
            ...
            if not self.hot_start:
                #
                dff, dgg = gradient.getGrad(x, group_ids, [f], g[0:len(opt_problem._constraints.keys())], *args,
                                            **kwargs)
