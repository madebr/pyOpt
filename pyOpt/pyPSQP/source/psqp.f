...
*  SE  PDCON  COMPUTATION OF THE GRADIENT OF THE CONSTRAINT FUNCTION.
...
* UPDATE.
*
      SUBROUTINE PSQP(NF,NB,NC,X,IX,XL,XU,CF,IC,CL,CU,CG,CFO,CFD,
     +                GC,ICA,CR,CZ,CP,GF,G,H,S,XO,GO,XMAX,TOLX,
     +                TOLC,TOLG,RPF,CMAX,GMAX,F,MIT,MFV,MET,MEC,
     +                IPRNT,IOUT,ITERM,POBJ,PDOBJ,PCON,PDCON)
*
      DOUBLE PRECISION F,CMAX,GMAX,RPF,TOLC,TOLD,TOLG,TOLS,TOLX,XMAX
      INTEGER          IPRNT,IOUT,ITERM,MET,MET1,MEC,MES,MFV,MIT,NB,
     +                 NC,NF
     ...
     +                 ITERS,KBC,KBF,KC,KD,KIT,LD,MRED,MTESF,MTESX,N,
     +                 K,NTESX,IEST,INITS,KTERS,MAXST,ISYS,MFP,NRED,
     +                 IPOM,LDS
...
*
   ...
   40 CONTINUE
      LDS=LD
      CALL PF1F01(NF,X,GF,GF,FF,F,KD,LD,IEXT,POBJ,PDOBJ)
      LD=LDS
...
11172 CONTINUE
      ...
      LDS=LD
      CALL PF1F01(NF,X,GF,G,FF,F,KD,LD,IEXT,POBJ,PDOBJ)
      LD=LDS
      CALL PC1F01(NF,NC,X,FC,CF,CL,CU,IC,GC,CG,CMAX,KD,LD,
     +                PCON,PDCON)
      CF(NC+1)=F
