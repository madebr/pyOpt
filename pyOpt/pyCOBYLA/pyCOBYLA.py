    ...
    def __init__(self, pll_type=None, *args, **kwargs):
        ...
        **Keyword arguments:**
        ...
        def_opts = {
            ...
            'IPRINT':
            [int, 2],  # Print Flag (0 - None, 1 - Final, 2,3 - Iteration)
        ...
        **Keyword arguments:**
        ...
        if self.poa:
            try:
                ...
                print(
                    'pyCOBYLA: Parallel objective Function Analysis requires mpi4py'
                )
        ...
        # Run COBYLA
        t0 = time.time()
        cobyla.cobyla(calcfc, n, m, xx, rhobeg, rhoend, iprint, maxfun, w,
                      iact, ifail, nfvals, iout, ifile, ff, gg)
