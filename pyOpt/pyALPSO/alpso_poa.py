...
Revision: 1.0   $Date: 12/04/2010 21:00$
...
History
-------
        v. 1.0  - Initial Code Development (PJ, 2010)
...
try:
        ...
        print('alpso_poa: mpi4py library failed to import')
                ...
                while ((k_inn < maxInnIter) and (stop_inner == 0)):
                        ...
                        for i in range(swarmsize):
                                ...
                                for j in range(dimensions):
                                        if (i == swarm_i):
                                                rr = rand.random()
                                                v_k[i, j] = w * v_k[i, j] + -x_k[i, j] + \
                                                    swarm_x[j] + rho * (1.0 - 2.0 * rr)
                                        else:
                                                r1 = rand.random()
                                                r2 = rand.random()
                                                rc = rand.random()
